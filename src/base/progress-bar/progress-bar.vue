...
<script>
  ...
  const progressBtnWidth = 16 // 球球的宽度
  const trsnsform = prefixStyle('transform')
  ...
  export default {
    ...
    methods: {
      ...
      _offset(offsetWidth) {
        ...
        this.$refs.progressBtn.style[trsnsform] = `translate3d(${offsetWidth}px,0,0)`
      },
      _triggerPercent() {
